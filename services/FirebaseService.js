...
FirebaseService.getOwnersDigitalItemsRequest = async (id) => 
		await db.collection("digitalItem").where("ownerId", "==", id).get();
...
// 		await db.collection("reviews").where("restaurantOwnerId", "==", id).get();
